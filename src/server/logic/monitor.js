...
module.exports = function(router) {
  ...
  router.get('/monitor/ac', (req, res) => {
    ...
    const result = _.map(_.range(0, count), (v, i) =>
      Mock.mock({
        id: i,
        exchangeMac: mac(),
  ...
  const wifiSsids = ['建德医院WIFI', 'JDRMYY-WIFI', 'CMCC', 'ChinaNet', 'ChinaUnicom'];
  router.get('/monitor/ap', (req, res) => {
    ...
    const result = _.map(_.range(0, count), (v, i) =>
      Mock.mock({
        ...
        'fapDeviceFactory|1': ['寰创', '锐捷', '敦崇'],
        'fapDeviceModel|1': ['双频', '室内双频2*2', '单频', '室内单频2*2'],
        ...
        'description|1': ['双频', '室内双频2*2', '单频', '室内单频2*2'],
